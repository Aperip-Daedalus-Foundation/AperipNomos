...
read-only catalog APIs on port 54871. The administrator listener exposes
authenticated mutation APIs on port 54872. Both listeners share a bounded
...
with a read-only root filesystem. Compose exposes ports 54871 and 54872, mounts a
